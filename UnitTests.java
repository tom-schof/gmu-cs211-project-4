...
public class UnitTests { 
    ...
    public void testParser1(){ 
        ...
        System.out.println( "((TagNode)root.getChildren(): " + root.getChildren().size() );
    ...
    public void testKeywords1(){ 
        ...
        FileParser parser = new FileParser(); 
        parser.createTree(data); 
        System.out.println("root: " + parser.getRoot().getTag());
        System.out.println("HTML Children: " +  parser.getRoot().getChildren().size());
    ...
    public void countPassed(){ 
        System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=guest-project5_0-PROGRESS"));             
        assertEquals(15,passed); 
        if (passed == 15) 
            System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=guest-project5_0-COMPLETED"));             
